...
const Login = () => {
  ...
  return (
    <>
      {/* ── MOBILE: plain white full-screen, centered form ── */}
      <div className="flex md:hidden w-full min-h-dvh bg-white overflow-y-auto">
        <div className="w-full flex items-center justify-center py-10 px-6">
          <div className="w-full max-w-md">

            <h2 className="text-3xl -mt-10 font-bold text-[#2FA77A] text-center mb-8">
              Welcome back
            </h2>
